...
export default function MenuItem({ item }: { item: MenuItem }) {
  ...
  return (
    <div className="bg-itembackground flex w-full flex-col items-center justify-between gap-4 p-4">
      <Link
      ...
      <div className="flex w-full flex-row items-center justify-between gap-4">
        <Link
          className="bg-menusecondary-foreground rounded-3xl p-2 px-2 py-1 tracking-[1px] text-[#000]"
          href={`/menu/${item._id}`}
        >
