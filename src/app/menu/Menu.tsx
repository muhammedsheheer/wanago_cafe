                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      activeCategory === category._id
                        ? "bg-menuprimary text-[#000] hover:bg-buttonhover hover:text-[#000]"
                        : "border-[1px] border-menuprimary bg-transparent text-menuprimary hover:bg-menuprimary hover:text-[#000]",
